...
from SoccerNet.Evaluation.utils import INVERSE_EVENT_DICTIONARY_V2, EVENT_DICTIONARY_V2
...
def get_class2id_map(dataset: str, dataset_dir: str = "./dataset") -> Dict[str, int]:
    ...
    class2id_map = INVERSE_EVENT_DICTIONARY_V2.copy()
    class2id_map[17] = "background"
    #class2id_map = EVENT_DICTIONARY_V2.copy()
    #class2id_map["background"] = 17
